...
. Add the starter dependency for Spring Boot Actuator. Verify that the dependency uses the autoconfiguration to open an endpoint via https://localhost:8080/actuator/health[`localhost:8080/actuator/health`].
